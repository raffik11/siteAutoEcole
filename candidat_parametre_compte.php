            ...
            <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">mot de passe</a></li>  
                         ...
                         <div id="content_1" class="content"> 
                             ...
                             <tr>
                               <form id="myform" method="post" action="candidat_parametre.php">
                                ...
                                <td><label for="login_encien" class="rub">Ancien Pseudo :</label></td>
                                <td><input name="login_encien" id="login_encien" type="text" /></td>
          
                                </tr>
         
                                <tr>
                                    <td><label for="login_nouveau" class="rub">Nouveau Pseudo :</label></td>
                             ...
                             <td> <label for="pwd_encien" class="rub">Ancien Mot de passe : </label></td>
                             <td> <input name="pwd_encien" id="pwd_encien" type="password" /> </td>
          
                                </tr>
                                 <tr>
         
                              <td><label  for="pwd_nouveau" class="rub">Nouveau Mot de passe : </label></td>
                              <td>
                                ...
                                <td><label  for="pwd_nouveau2" class="rub">Mot de passe  (confirmation): </label></td>
                                <td>
                             ...
                             <tr>
                               <form id="myform" method="post" action="candidat_parametre_ps.php">
                                ...
                                <td><label for="login_encien1" class="rub">Ancien Pseudo :</label></td>
                                <td><input name="login_encien" id="login_encien1" type="text" /></td>
          
                                </tr>
         
                                <tr>
                                    <td><label for="login_nouveau1" class="rub">Nouveau Pseudo :</label></td>
                        ...
                        <div id="content_3" class="content">
                               ...
                               <form id="myform" method="post" action="candidat_parametre_mdp.php">
                                                     <td> <label for="pwd_encien1" class="rub">Ancien Mot de passe : </label></td>
                             <td> <input name="pwd_encien" id="pwd_encien1" type="password" /> </td>
          
                                </tr>
                                 <tr>
         
                              <td><label  for="pwd_nouveau1" class="rub">Nouveau Mot de passe : </label></td>
                              <td>
                                ...
                                <td><label  for="pwd_nouveau21" class="rub">Mot de passe  (confirmation): </label></td>
                                <td>
