      ...
      <div class="border_table" >
        <table width="100%">
          ...
          <tr>
            ...
            <td width="500" ><div align="justify" class="taille_cellule"> <?php echo $rep['message']; ?></div></td>
          </tr>
          <?php 
		      if($rep['nbre_rep']==0)
			  {?>
          <tr> <?php echo ' <td id="cellule">  <a href="admin_repondre.php?id_q='.$id.'"> <img style="vertical-align: middle;" src="image/repondre.png"></a></td>';?> </tr>
          <?php }else
		            {
		             echo'<tr valign=bottom><td id="cellule" width=450 align=right><sup class="nbr_msg"><blink>Vous avez '.$nbr.' réponse </blink> </sup>  <a href="admin_voire.php?id_q='.$id.'"><img style="vertical-align: middle;" src="image/voire.jpg" ></a>  <a href="admin_repondre.php?id_q='.$id.'"><img style="vertical-align: middle;" src="image/repondre.png"></a></td></tr>';
				    }
			        ?>
        </table>
      </div>
...
?>
<div class="a"><a class="lien_simple" href="admin_forum2.php">plus de commentaire</a></div>
