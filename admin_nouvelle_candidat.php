  ...
  <div id="corps">
    ...
    <div class="form_parametre">
	 ...
	 <div class="div_messagerie">
	    <form name="form" method="post" action="admin_nouvelle_candidat_traitement.php" onSubmit="return verification()">
    ...
    <p class="text_insc2"> --> <a href="javascript:OuvrirFenetre('admin_nouvelle_visual_candidat.php','popup','width=700,height=400,left=300,top=150,resizable=no,status=no')" class="lien_plan Style26">Visualiser le résultat</a> <--</p>
