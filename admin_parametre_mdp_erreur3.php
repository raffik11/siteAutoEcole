...
<?php include ("menu_admin.php");?>
  ...
  <div id="corps">
    ...
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">Modifier identifiant et mot de passe</a></li>  
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">Modifier identifiant </a></li>  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">Modifier mot de passe</a></li>  
        </ul>  
				        ...
				        <table width=75% >
						    <tr>
	                         ...
	                         <tr>
							  ...
							  <tr>
	                           <td colspan=2> <img style="vertical-align: middle;" src='image/erreur.png'  /> <span class="erreur">Erreur lors de la confirmation du mot de passe !!!</span><br><br></td>
	                           </tr>
	                          <tr >
