...
<?php
			...
			$reponse=mysql_query("UPDATE nouvelle SET titre_nouv ='".$_POST['nouv_p']."', nouvelle ='".$nouv1."',datenouv='".$dat."' ");
				
				
				
				
            echo "<META http-equiv='refresh' content='0; URL=admin_nouvelle.php'>";
