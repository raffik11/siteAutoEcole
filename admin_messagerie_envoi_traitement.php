...
<?php
   //verifiction des informations ( saisie) 
     ...
     if (  $_POST['pseudo']!="pseudo_des" and  !empty($_POST['objet'] ) and !empty($_POST['sujet'] ) and  !empty($_POST['msg'] ) )
      {
	  ...
	  {
	  echo "<META http-equiv='refresh' content='0; URL=admin_messagerie_envoi_erreur.php'>";
	  }
