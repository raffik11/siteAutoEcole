...
?>
	   <div class="border_table" >
		 ...
		 <?php }else
		            {
		             echo'<tr valign=bottom><td id="cellule" width=450 align=right><sup class="nbr_msg"><blink>Vous avez '.$nbr.' réponse </blink> </sup> <a href="candidat_voire.php?id_q='.$id.'"><img style="vertical-align: middle;" src="image/voire.jpg" ></a>  <a href="candidat_repondre.php?id_q='.$id.'"><img style="vertical-align: middle;" src="image/repondre.png"></a></td></tr>';
				    }
			        ?>
          </table>
	    </div>
