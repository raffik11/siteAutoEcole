...
<?php include ("menu_candidat.php");?>
  ...
  <div id="corps">
    ...
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">pseudo et mot de passe</a></li>  
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">pseudo </a></li>  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">mot de passe</a></li>  
        </ul>  
