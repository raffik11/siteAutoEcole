...
<div id="tabbed_box_1" class="tabbed_box">  
   ...
   <?PHP 
           ...
           {	?>	
             ...
             <div class="font_info"><img style="vertical-align: middle;" src="image/info.png"/><b> <?php echo $rep['titre_exam']; ?></b></div>
        ...
        <div id="content_3" class="content">
			  ...
			  <div  class="text_accueil1">
		      - Nouvelle mise à jour des news le <?php echo $rep['dateexam']; ?>
			  </div>
		</div>  
 <?php 
	   } ?> 
