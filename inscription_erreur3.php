...
<div id="corps">
   <div class="titre"> <img style="vertical-align: middle;" src='image/mail.png'/> Formulaire d'inscription:</div>
   <div class="form_parametre_insc">

   
   
   <img src='image/erreur1.png'  /> <span class="erreur"> Erreur lors de la confirmation du mot de passe !!!</span> <br><br> <!--message d'erreur-->
          <strong class="text_insc"> les champs indiqués par une étoile sont obligatoires </strong><br><br>
    <form id="myForm" method="post" action="confirmation_inscription.php">
      ...
      <span class="tooltip">  <img style="vertical-align: middle;" src='image/erreur.png'  /> Le mot de passe de confirmation doit être identique à celui d'origine</span><br>
	  
	  <p class="text_insc2"><img src="image/information.png" /> Phrase secrète: en cas ou vous oublier le mot de passe,cette phrase est indispensable pour le récuperer</p>  
