...
<div class="titre_nett_forum"> Mettre a jour le forum</div> 
...
mysql_select_db("auto_ecole");?>
 ...
 <?php 
$reponse = mysql_query("SELECT * FROM forum ORDER BY id_com DESC LIMIT 0,2");
...
?>
	   <div class="border_table" >
		   ...
		   <tr>
				   ...
				   <?php echo' <td id="cellule3"><a href="admin_forum_supp.php?id_q='.$id.'"><img style="vertical-align: middle; height:18px; width:18px;" src="image/b_drop.png" title="supprimer"/> </a> </td> ';?>
		   </tr>
		     <tr>
...
?>
<div class="a"><a class="lien_simple" href="admin_forum2_mettre_a_jour.php">plus de publications</a></div>
