    ...
    <div class="tabbed_area">  
        ...
        <ul class="tabs">  
            ...
            <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">mot de passe</a></li>  
                 ...
                 <img style="vertical-align: middle;" src='image/erreur.png'  /> <span class="erreur">Acces refusé : veuillez saisir votre Pseudo et mot de passe.</span><br><br>				 
				       <table width=75%>
                             <tr>
...
<?php include ("candidat_abonnee.php");?>	
<?php } ?>