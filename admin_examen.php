  ...
  <div id="corps">
    ...
    <div class="form_parametre">
	 ...
	 <div class="div_messagerie">
	    <form name="form" method="post" action="admin_exam_traitement.php" onSubmit="return verification()">
		   <table width="100%" id="table_messagerie2">
		     <!--DWLayoutTable-->
		   
		     <tr>
		           <td width=27% class="td"><label for="nouv_p">Titre Examen : *</label></td>
		            <td width=55%>
					<textarea name="nouv_p" id="nouv_p" rows="2" cols="30" ></textarea>					</td>
					<td></td>
		     </tr>
			 <tr>
		           <td width=27% class="td"><label for="nouv_1">Examen : *</label></td>
		            <td width=55%>
    ...
    <p class="text_insc2"> --> <a href="javascript:OuvrirFenetre('admin_exam_visual.php','popup','width=700,height=400,left=300,top=150,resizable=no,status=no')" class="lien_plan Style26">Visualiser le résultat</a> <--</p>
