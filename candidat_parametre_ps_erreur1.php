...
<?php include ("menu_candidat.php");?>
  ...
  <div id="corps">
    ...
    <div class="tabbed_area">  
        ...
        <ul class="tabs"> 		
            <li><a href="javascript:tabSwitch('tab_2', 'content_2');" id="tab_2">pseudo et mot de passe</a></li>  
            <li><a href="javascript:tabSwitch('tab_1', 'content_1');" id="tab_1" class="active">pseudo </a></li>  
             <li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">mot de passe</a></li> 
				...
				<img style="vertical-align: middle;" src='image/erreur.png'  /> <span class="erreur">Acces refusé : veuillez saisir votre Pseudo.</span><br><br>
				      <table width=70% >
                             <tr>
