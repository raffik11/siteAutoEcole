	         ...
	         if ($existe)
                      {
					   if ($n_mdp==$c_mdp)
						{
						    mysql_query("UPDATE admin SET pseudo='$n_login',motp='$n_mdp' WHERE pseudo='$login'");
						 ...
						 echo "<META http-equiv='refresh' content='0; URL=admin_parametre_erreur3.php'>";
						 }
	  
	
	                  }else
	                         {
		                      echo "<META http-equiv='refresh' content='0; URL=admin_parametre_erreur2.php'>";
		                     }
	}else
	  {
	  echo "<META http-equiv='refresh' content='0; URL=admin_parametre_erreur1.php'>";
	  }
